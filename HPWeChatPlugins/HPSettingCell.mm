#line 1 "/Volumes/HOTPOTCAT/practice/HPWeChatPlugins/HPWeChatPlugins/HPSettingCell.xm"


#import <UIKit/UIKit.h>

#define HPIMAGE(path) @"/Library/Caches/com.hotpotcat.HPWeChatPlugins/" #path
...
#line 28 "/Volumes/HOTPOTCAT/practice/HPWeChatPlugins/HPWeChatPlugins/HPSettingCell.xm"
...
static id _logos_method$_ungrouped$WCTableViewManager$tableView$cellForRowAtIndexPath$(_LOGOS_SELF_TYPE_NORMAL WCTableViewManager* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UITableView * tableView, NSIndexPath * indexPath) {
    if ([self isNewSettingVC:tableView] && (indexPath.section == [self numberOfSectionsInTableView:tableView] - 1)) { 
        ...
        if(indexPath.row == 0) {
            ...
            cell.imageView.image = [UIImage imageWithContentsOfFile:switchOn ? HPIMAGE(HP_switch_on@2x.png) : HPIMAGE(HP_switch_off@2x.png)];
            ...
            cell.imageView.image = [UIImage imageWithContentsOfFile:HPIMAGE(HP_time@2x.png)];
...
#line 158 "/Volumes/HOTPOTCAT/practice/HPWeChatPlugins/HPWeChatPlugins/HPSettingCell.xm"
